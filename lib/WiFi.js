...
const debug = require('debug')('connman-simplified:wifi');
...
const _super = Base.prototype;

const _timeoutWiFiEnable = 3000;
const _timeoutJoin = 35000;
const _numGetServiceAttempts = 15;
const _timeoutServicesChanged = 5000;
const _numServicesChangedEvents = 2;
const _getServiceAttemptTimeout = 10000;

let _servicesCache = []; // cache of services, use while tethering

let _lockOpenHotspot = false;
let _lockCloseHotspot = false;
let _lockJoin = false;
